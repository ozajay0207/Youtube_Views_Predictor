...
def get_video_details(V_id,name,type,url1,request):
    ...
    video_main(video_name=name,category=category,youtube_url=url1,publish_date=publish_date,analysis_status=False,user_id=users.objects.get(pk=request.session['User_Id']))
	    #print("\n",k,"\n",v,"\n")
